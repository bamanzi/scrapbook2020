...
@media print {
  ...
  div.thumbinner { background-color: rgb(255, 255, 255); border: 1pt solid rgb(204, 204, 204); padding: 3px ! important; font-size: 94%; text-align: center; overflow: hidden; }
...
@media screen {
  ...
  .body_content h3, .body_content h4, .body_content h5 { margin-bottom: 0.3em; }
  ...
  #toc, .toc, .mw-warning { border: 1px solid rgb(170, 170, 170); background-color: rgb(249, 249, 249); color: black; padding: 5px; font-size: 95%; }
  #toc, .toc { display: inline-block; }
  #toc h2, .toc h2 { display: inline; border: medium none; padding: 0px; font-size: 100%; font-weight: bold; }
  #toc #toctitle, .toc #toctitle, #toc .toctitle, .toc .toctitle { text-align: center; }
  #toc ul, .toc ul { list-style-type: none; list-style-image: none; margin-left: 0px; padding-left: 0px; text-align: left; }
  #toc ul ul, .toc ul ul { margin: 0px 0px 0px 2em; }
  #toc .toctoggle, .toc .toctoggle { font-size: 94%; }
  div.thumb { margin-bottom: 0.5em; width: auto; }
  div.thumbinner { color: black; border: 1px solid rgb(204, 204, 204); padding: 3px ! important; background-color: rgb(249, 249, 249); font-size: 94%; text-align: center; overflow: hidden; }
  div.thumbinner a { color: rgb(0, 43, 184); }
  html .thumbimage { border: 1px solid rgb(204, 204, 204); }
  html .thumbcaption { border: medium none; text-align: left; line-height: 1.4em; padding: 3px ! important; font-size: 94%; }
  div.magnify { float: right; border: medium none ! important; background: transparent none repeat scroll 0% 0% ! important; }
  div.magnify a, div.magnify img { display: block; border: medium none ! important; }
  div.tright { clear: right; float: right; margin: 0.5em 0px 1.2em 1.4em; }

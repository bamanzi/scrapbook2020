...
.mw-ui-icon-wikimedia-search::before { background-image: linear-gradient(transparent, transparent), url("search.svg"); }
...
@media screen {
  ...
  .searchButton[name="go"] { background: transparent url("search_001.svg") no-repeat scroll center center / 1.23077em auto; opacity: 0.67; }
...
@media screen {
  ...
  .vector-body #contentSub, .vector-body #contentSub2 { font-size: 84%; line-height: 1.2em; margin: 8px 0px 0px; color: rgb(84, 89, 93); width: auto; }
